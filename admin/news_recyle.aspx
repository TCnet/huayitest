<%@ Page Language="C#" Inherits="HuaYimo.admin.news_recyle" %>
    ...
    <script type="text/javascript">         
            function DeleteIt(id,page,type)
            {
                ...
                {                   
                    ...
                    document.location="news_recyle.aspx?del="+id+"&page="+page+"&type="+type+"&reUrl="+url;                 
                }               
            }
...
<div id="right_table">
    ...
    <table align="center" border="0" cellpadding="3" cellspacing="1" class="tableBorder" style="line-height: 14pt">
         ...
         <ItemTemplate>
         [<%#Request["t"]==Eval("id").ToString()?"<strong>":"" %><a href="news_recyle.aspx?t=<%#Eval("id")+(Request["type"]==null?"":"&type="+Request["type"])%>"><%#Eval("typename") %></a><%#Request["t"]==Eval("id").ToString()?"</strong>":"" %>]&nbsp;
         </ItemTemplate>
         </asp:Repeater>
            </td>
            </tr>
    ...
    <asp:Repeater ID="rtNews" runat="server" EnableViewState="false" 
        ...
        <ItemTemplate>
            ...
            <td class="forumRow" align="center">  
               ...
               <a href="news_recyle.aspx?back=<%# Eval("id") %>">还原</a> | 
               
                <a href="javascript:DeleteIt(<%# Eval("id") %>,<%#Request["page"]==null?"0":Request["page"] %>,<%#Request["type"] %>)">彻底删除</a>
            </td>
        </tr>
        </ItemTemplate>
        <FooterTemplate>
    ...
    &nbsp;&nbsp;
    <asp:Button ID="bgFlag" runat="server" Text="批量还原" onclick="bgFlag_Click" /> 
